...
public abstract class BackUpBaseFragment extends Fragment {
    ...
    public void populateResult(List<User> users) {
        ...
        listAdapter = baseExpandableListPopulator.getExpandableListAdapter(getActivity(),users);
    ...
    public abstract BaseExpandableListPopulator getListPopulator();
    ...
    protected class HttpRequestTask extends AsyncTask<Void, Void, List<User>> {
        private BackUpBaseFragment container;

        public HttpRequestTask(BackUpBaseFragment container){
